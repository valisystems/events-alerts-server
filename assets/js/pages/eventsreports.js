...
function sendAjaxToSearch(searchCriteria){
    ...
    $('#exportContent').html("");
    var urlAction = '/admin/eventsReports/reportSearch';
    var urlActionChart = '/admin/eventsReports/reportSearchChart';
    var dataForm = $('#eventsReport-form').serialize();
    //var urlLink = "/admin/eventsReports/reportPdf/searchData/"+btoa(dataForm)+"/format/pdf";
    var urlLink = "/admin/eventsReports/reportExcel/searchData/"+btoa(dataForm)+"/format/pdf";
    var urlLinkExcel = "/admin/eventsReports/reportExcel/searchData/"+btoa(dataForm);
...
function exportPDFFromSearch(){
    ...
    var urlAction = '/admin/eventsReports/reportPdf';
    var dataForm = $('#eventsReport-form').serialize();
    $.ajax({
        url: urlAction,                   //
        type: "POST",
