...
function sendAjaxToSearch(searchCriteria){
    ...
    $('#exportContent').html("");
    var urlAction = '/admin/cdr/getCdr';
    var urlActionChart = '/admin/cdr/getCdrChart';
    var dataForm = $('#cdrReport-form').serialize();
    var urlLink = "/admin/cdr/reportExcel/searchData/"+btoa(dataForm)+"/format/pdf";
    var urlLinkExcel = "/admin/cdr/reportExcel/searchData/"+btoa(dataForm);
