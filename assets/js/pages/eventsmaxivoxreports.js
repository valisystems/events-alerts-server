...
function sendAjaxToSearch(searchCriteria){
    ...
    $('#exportContent').html("");
    var urlAction = '/admin/eventsMaxivoxReports/reportSearch';
    var urlActionChart = '/admin/eventsMaxivoxReports/reportSearchChart';
    var dataForm = $('#eventsReport-form').serialize();
    //var urlLink = "/admin/eventsReports/reportPdf/searchData/"+btoa(dataForm)+"/format/pdf";
    var urlLink = "/admin/eventsMaxivoxReports/reportExcel/searchData/"+btoa(dataForm)+"/format/pdf";
    var urlLinkExcel = "/admin/eventsMaxivoxReports/reportExcel/searchData/"+btoa(dataForm);
    ...
    //            },
    //            title: {
    //                text: 'MaxiVox Notification Activity'
    //            },
    //            xAxis: {
    //                type: 'category',
    //                labels: {
...
function exportPDFFromSearch(){
    ...
    var urlAction = '/admin/eventsMaxivoxReports/reportPdf';
    var dataForm = $('#eventsReport-form').serialize();
    $.ajax({
        url: urlAction,                   //
        type: "POST",
