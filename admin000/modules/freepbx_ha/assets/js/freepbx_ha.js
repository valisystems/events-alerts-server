        ...
        success: function(data) {
            $.each(data, function(k, v) {
                if (typeof(v) == "object") {
                    ...
                    h += "<span class='right'><img src='/admin/images/bullet.png'> <span class='comment'>"+v[1]+"</span></span></div>";
                } else {
                    var h = "<div class='"+s+"' id='"+k+"'><span class='left'>"+v+"</span>";
                    h += "<span class='right'><img src='/admin/images/bullet.png'> <span class='comment'></span></span></div>";
                }
                $("."+s).last().after(h);
                $("#"+k).data('pending', true);
...
function addCheck(k, s, cmd, callback) {
   ...
   $.ajaxQueue({
        ...
        beforeSend: function(xhr, s) {
            $("#"+k+">.right>img").attr('src', '/admin/images/spinner.gif');
        ...
        success: function(data) {
            ...
            if (data['status'] == "ok") {
                $("#"+k+">.right>img").attr('src', '/admin/images/bullet_checked.png');
                $("#"+k+">span>.comment").fadeOut();
                $("#"+k).data('complete', true);
                $("#"+k).data('pending', false);
            } else if (data['status'] == "unimplemented") {
                $("#"+k+">.right>img").attr('src', '/admin/images/notify_error.png');
                $("#"+k+">span>.comment").fadeOut();
                $("#"+k).data('complete', true);
                $("#"+k).data('pending', false);
		...
		if (typeof(data['message']) == 'undefined') {
                ...
                $("#"+k+">.right>img").attr('src', '/admin/images/notify_critical.png');
		if (typeof(data['message']) == 'undefined') {
