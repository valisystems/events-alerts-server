...
<head>
	...
	<!-- start: CSS -->
	<link href="<?php echo Yii::app()->request->baseUrl; ?>/css/genius/bootstrap.min.css" rel="stylesheet">
	<link href="<?php echo Yii::app()->request->baseUrl; ?>/css/genius/style.min.css" rel="stylesheet">
	<link href="<?php echo Yii::app()->request->baseUrl; ?>/css/genius/retina.min.css" rel="stylesheet">
	<link href="<?php echo Yii::app()->request->baseUrl; ?>/css/genius/print.css" rel="stylesheet" type="text/css" media="print"/>
	<!-- end: CSS -->
	...
	<link rel="apple-touch-icon-precomposed" sizes="57x57" href="<?php echo Yii::app()->request->baseUrl; ?>/ico/apple-touch-icon-57-precomposed.png">
...
<body>
				...
				<ul class="nav navbar-nav pull-right">
					...
					<li class="dropdown">
						<a class="btn account dropdown-toggle" data-toggle="dropdown" href="index.html#">
							<div class="avatar"><img src="<?php echo Yii::app()->request->baseUrl; ?>/img/avatar.jpg" alt="Avatar"></div>
							<div class="user">
	...
	<!--[if !IE]>-->
			...
			<script src="<?php echo Yii::app()->request->baseUrl; ?>/js/jquery-2.1.0.min.js"></script>
	...
	<!--[if !IE]>-->
		...
		<script type="text/javascript">
			window.jQuery || document.write("<script src='<?php echo Yii::app()->request->baseUrl; ?>/js/jquery-2.1.0.min.js'>"+"<"+"/script>");
		</script>
	...
	<!--[if IE]>
		...
		<script type="text/javascript">
	 	window.jQuery || document.write("<script src='<?php echo Yii::app()->request->baseUrl; ?>/js/jquery-1.11.0.min.js'>"+"<"+"/script>");
		</script>
	...
	<script src="<?php echo Yii::app()->request->baseUrl; ?>/js/jquery.flot.stack.min.js"></script>
	<script src="<?php echo Yii::app()->request->baseUrl; ?>/js/jquery.flot.resize.min.js"></script>
	<script src="<?php echo Yii::app()->request->baseUrl; ?>/js/jquery.flot.time.min.js"></script>
	...
	<script src="<?php echo Yii::app()->request->baseUrl; ?>/js/daterangepicker.min.js"></script>
	<script src="<?php echo Yii::app()->request->baseUrl; ?>/js/jquery.easy-pie-chart.min.js"></script>
	...
	<script src="<?php echo Yii::app()->request->baseUrl; ?>/js/pages/index.js"></script>
