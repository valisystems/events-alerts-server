...
class SystemVoiceNumber extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('id_system_voice_number, description_voice_number, name_voice_number, number_to_call, descVoice', 'safe'),
		);
	}
	...
	{
		return array(
			'id_system_voice_number' => Yii::t('admin/systemvoicenumber','Id System Voice Number'),
			'description_voice_number' => Yii::t('admin/systemvoicenumber','Description Voice Number'),
			'name_voice_number' => Yii::t('admin/systemvoicenumber','Name Voice Number'),
			'number_to_call' => Yii::t('admin/systemvoicenumber','Number'),
		);
	}
	...
	public function getDescVoice(){
		return $this->description_voice_number.' ( '.$this->number_to_call.' )';
	}
