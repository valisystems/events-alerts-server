...
class SystemSmsNumbers extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('description_sms, name_sms, number_sms', 'required'),
            array('description_sms, name_sms', 'length', 'max'=>250),
			array('number_sms', 'length', 'max'=>15),
	...
	{
		return array(
			'id_system_sms_number' => Yii::t('admin/systemsmsnumber','Id System SMS Number'),
			'description_sms' => Yii::t('admin/systemsmsnumber','Description SMS'),
			'name_sms' => Yii::t('admin/systemsmsnumber','Name SMS'),
			'number_sms' => Yii::t('admin/systemsmsnumber','Number SMS'),
		);
	}
