 ...
 */
class PickMaxivoxEvents extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('id_event_maxivox', 'numerical', 'integerOnly'=>true),
			array('pick_event_type', 'length', 'max'=>8),
			array('id_contact', 'length', 'max'=>10),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id_pick_maxivox_event, id_event_maxivox, pick_event_type, id_contact, id_command, id_iodevice', 'safe'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'idEventMaxivox' => array(self::BELONGS_TO, 'EventsMaxivoxManage', 'id_event_maxivox'),
		);
	}
	...
	{
		return array(
			'id_pick_maxivox_event' => 'Id Pick MaxiVox Event',
			'id_event_maxivox' => 'Id Event MaxiVox',
	...
	public function search()
	{
		...
		$criteria->compare('id_pick_maxivox_event',$this->id_pick_pendant_event);
		$criteria->compare('id_event_maxivox',$this->id_event_pendant);
