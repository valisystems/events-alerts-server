...
<div class="col-xs-12 col-md-12 col-sm-12">
    ...
    <?php $form=$this->beginWidget('CActiveForm', array(
        ...
        <?php echo $form->hiddenField($model,'id_event',array('id'=>'id_event')); ?>
        <div id="id_call_type_tmp" tochange="<?php echo $model->id_call_type;?>"></div>
        <div id="id_notification_settings_tmp" tochange="<?php echo $model->id_notification_settings;?>"></div>
        ...
        <div class="row">
            ...
            <div class="input-group date col-sm-4">
                ...
                <?php
                echo $form->dropDownList($model,'id_room',array(), array('class'=>'form-control','style'=>"width: 250px;")
                    );
                ?><br />
            </div>
            <div class="col-lg-6">
        ...
        <div id="eventAdditionalSettings" style="display: none;" class="row">
