...
<div class="form">
    <div class="box">
        <div class="box-header">
            <h2><i class="fa fa-floppy-o"></i> Event Pendant Reports</h2>
                ...
                <div class="row">
                    <div class=" col-xs-12 col-sm-12 col-md-12">
                        ...
                        <div class="input-group col-sm-4">
                            ...
                            <?php
                                echo  CHtml::dropDownList('code', '', CHtml::listData(PendantType::model()->findAll(), 'script','description'), array('class'=>'form-control','style'=>"width: 250px;",'data-rel'=>"chosen", 'prompt' => Yii::t('admin/eventsreports','Select Call Type')));
                            ?>
                        ...
                        <div class="input-group col-sm-4">
                            ...
                            <select class="form-control" id="patient" name="patient">
                                ...
                                $sql = "SELECT p.id_patient, concat(p.first_name, ' ', p.last_name) as patient FROM {{patients}} p
                                        INNER JOIN {{pendant_devices}} pd ON p.id_patient = pd.id_patient
