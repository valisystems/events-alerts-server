...
$this->breadcrumbs=array(
    Yii::t('admin/cdr', 'CDR')=>array('index'),
);
    ...
    <div class="form">
        <div class="box">
            <div class="box-header">
                <h2><i class="fa fa-floppy-o"></i> CDR</h2>
...
<table class="hover display" id="resultCDR" data-page-length='25' style="display:none;">
    <thead>
    <tr>
        <th data-sortable="true" data-field="calldate">Call Date</th>
        <th data-sortable="true" data-field="clid">CallerID</th>
        <th data-sortable="true" data-field="src">Outbound CallerID</th>
        <th data-sortable="true" data-field="dst">Destination</th>
        <th data-sortable="true" data-field="billsec">Duration</th>
        <th data-sortable="true" data-field="disposition">Disposition</th>
    </tr>
    </thead>
</table>