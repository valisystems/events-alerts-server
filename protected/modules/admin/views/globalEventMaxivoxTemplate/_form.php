...
<?php $form=$this->beginWidget('CActiveForm', array(
	'id'=>'global-event-maxivox-template-form',
...
<div class="row col-lg-6">
    ...
    <div class="row">
		<div class="col-lg-6">
            <label class="control-label" for="id_pendant_type"><?php echo $form->labelEx($model,'id_maxivox_type'); ?></label>
            <div class="input-group date col-sm-4">
                <span class="input-group-addon">
                    <i class="fa  fa-info-circle"></i>
                </span>
            <div class="input-group date col-sm-4">
                <?php
                    echo $form->dropDownList($model, 'id_maxivox_type', CHtml::listData(MaxivoxType::model()->findAll(), 'id_maxivox_type','description'), array('class'=>'form-control','style'=>"width: 250px;",'data-rel'=>"chosen", 'prompt' => Yii::t('admin/maxivox','Select MaxiVox Type'),));
                ?>
            </div>
            </div><br />
            <div>
                <?php echo $form->error($model,'id_maxivox_type', array('class' => 'alert alert-danger')); ?>
            </div>
        </div>
	</div>
    <div class="row">
                    ...
                    <?php
                        echo $form->dropDownList($model, 'pick_event_type', Yii::app()->params['pick_event_type'],
                                array(
                                    ...
                                    'prompt' => Yii::t('admin/globalEventMaxivox','Select Event Type'),
                                    'ajax' => array(
                                        'type'=>'POST',
                                        ...
                                        'success' =>'function(data){
                                            ...
                                            $(".GlobalEventMaxivoxTemplate_receiver").change(receiverAction);
                                        }',
    ...
    <div class="row">
		<div class="col-lg-6">
            ...
            <div class="input-group date col-sm-4">
                ...
                <div class="input-group date col-sm-4">
                    <?php
                        echo $form->dropDownList($model, 'id_global_message', CHtml::listData(GlobalMessages::model()->findAll(), 'id_global_message','global_description'), array('class'=>'form-control','style'=>"width: 250px;",'data-rel'=>"chosen", 'prompt' => Yii::t('admin/maxivox','Select Global Description'),));
                    ?>
                </div>
            </div><br />
            <div>
    ...
    <div class="row">
		<div class="col-lg-6">
            ...
            <div class="input-group date col-sm-4">
                ...
                <div class="input-group date col-sm-4">
                    <?php
                        echo $form->dropDownList($model, 'live_panel', array('Y' => Yii::t('admin/maxivox','Yes'), 'N' => Yii::t('admin/maxivox','No')), array('class'=>'form-control','style'=>"width: 250px;",'data-rel'=>"chosen", 'prompt' => Yii::t('admin/maxivox','Choose Options'),));
                    ?>
                </div>
            </div><br />
            <div>
    ...
    <div class="row">
		<div class="col-lg-6">
            ...
            <div class="input-group date col-sm-4">
                ...
                <div class="input-group date col-sm-4">
                    <?php
                        echo $form->dropDownList($model, 'require_acknowledge', array('Y' => Yii::t('admin/maxivox','Yes'), 'N' => Yii::t('admin/globalevent','No')), array('class'=>'form-control','style'=>"width: 250px;",'data-rel'=>"chosen", 'prompt' => Yii::t('admin/globalevent','Choose Options'),));
                    ?>
                </div>
            </div><br />
            <div>
    ...
    <div class="row">
		<div class="col-lg-6">
            ...
            <div class="input-group date col-sm-4">
                ...
                <div class="input-group date col-sm-4">
                    <?php
                        echo $form->dropDownList($model, 'flashing_toggle', array('Y' => Yii::t('admin/maxivox','Yes'), 'N' => Yii::t('admin/globalevent','No')), array('class'=>'form-control','style'=>"width: 250px;",'data-rel'=>"chosen", 'prompt' => Yii::t('admin/globalevent','Choose Options'),));
                    ?>
                </div>
            </div><br />
            <div>
    ...
    <div class="row">
		<div class="col-lg-6">
            ...
            <div class="input-group date col-sm-4">
                ...
                <div class="input-group date col-sm-4">
                    <?php
                        echo $form->dropDownList($model, 'auto_close', array('Y' => Yii::t('admin/maxivox','Yes'), 'N' => Yii::t('admin/globalevent','No')), array('class'=>'form-control','style'=>"width: 250px;",'data-rel'=>"chosen", 'prompt' => Yii::t('admin/globalevent','Choose Options'),));
                    ?>
                </div>
            </div><br/>
