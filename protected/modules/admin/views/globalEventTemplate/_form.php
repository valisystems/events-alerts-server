...
<div class="row col-lg-6">
    ...
    <div class="row">
		<div class="col-lg-6">
            <label class="control-label" for="id_call_type"><?php echo $form->labelEx($model,'id_call_type'); ?></label>
            <div class="input-group date col-sm-4">
                <span class="input-group-addon">
                ...
                <div class="input-group date col-sm-4">
                    <?php
                        echo $form->dropDownList($model, 'id_call_type', CHtml::listData(CallsType::model()->findAll(), 'id_call_type','description'), array('class'=>'form-control','style'=>"width: 250px;",'data-rel'=>"chosen", 'prompt' => Yii::t('admin/globalevent','Select Call Type'),));
                    ?>
                </div>

            </div><br/>
            <div>
                <?php echo $form->error($model,'id_call_type', array('class' => 'alert alert-danger')); ?>
            </div>
        </div>
	</div>
    <div class="row">
                    ...
                    <?php
                        echo $form->dropDownList($model, 'pick_event_type', Yii::app()->params['pick_event_type'],
                                array(
                                    ...
                                    'prompt' => Yii::t('admin/globalevent','Select Event Type'),
                                    'ajax' => array(
                                        'type'=>'POST',
                                        ...
                                        'success' =>'function(data){
                                            ...
                                            $(".GlobalEventTemplate_receiver").change(receiverAction);
                                        }',
