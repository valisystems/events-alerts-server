...
$this->breadcrumbs=array(
	...
	Yii::t('admin/globalevent', 'Manage'),
);
?>
<h1><?php echo Yii::t('admin/globalevent', 'Manage Global Event Templates');?></h1>
...
<?php $this->widget('zii.widgets.grid.CGridView', array(
	...
	'columns'=>array(
		...
		array(
            'name'=>'id_call_type',
            'value'=>'$data->idCallsType->description',
            'filter'=>CHtml::listData(CallsType::model()->findAll(), 'id_call_type','description')
        ),
        array(
