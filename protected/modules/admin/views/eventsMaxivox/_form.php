...
<div class="col-xs-12 col-md-12 col-sm-12">
    ...
    <?php $form=$this->beginWidget('CActiveForm', array(
        ...
        <div class="row">
            <div class="form-group">
                <label class="control-label" for="event_type"><?php echo $form->label($model,Yii::t('admin/eventsmaxivox','event_maxivox_type')); ?></label>
                <div class="input-group date col-sm-4">
                   <span class="input-group-addon">
                    ...
                    <?php
                        echo $form->dropDownList($model, 'event_type',Yii::app()->params['event_type'],
                            array(
                                    ...
                                    'prompt' => Yii::t('admin/eventsmaxivox','Select Event Type'),
                                )
                            );
                    ?>
                </div>
