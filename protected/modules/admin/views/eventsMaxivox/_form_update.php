...
<div class="col-xs-12 col-md-12 col-sm-12">
    ...
    <?php $form=$this->beginWidget('CActiveForm', array(
        ...
        <?php echo $form->hiddenField($model,'id_event_maxivox',array('id'=>'id_event')); ?>
        <div id="id_maxivox_type_tmp" tochange="<?php echo $model->id_maxivox_type;?>"></div>
            ...
            echo $form->dropDownList($model, 'id_building', CHtml::listData(Buildings::model()->findAll(), 'id_building','name'),
                array(
                    ...
                    'ajax' => array(
                        ...
                        'update'=>'#'.CHtml::activeId($model, 'id_maxivox_device'), // ajax updates package_id, but I want ajax update registration_id if I select item no 4
    	...
    	<div class="row">
            <label class="control-label" for="id_maxivox_device"><?php echo $form->labelEx($model,Yii::t("admin/rooms",'Device')); ?></label>
            <div class="input-group date col-sm-4">
                <span class="input-group-addon">
                    <i class="fa  fa-dashboard"></i>
                </span>
                <?php
                        echo $form->dropDownList($model, 'id_maxivox_device', array(),
                            array(
                                    'class'=>'form-control',
                                    'style'=>"width: 250px;",
                                    //'data-rel'=>"chosen",
    		...
    		<?php echo $form->error($model,'id_maxivox_device'); ?>
    	</div>
        <div class="row">
            <div class="form-group">
                <label class="control-label" for="event_maxivox_type"><?php echo $form->label($model,Yii::t('admin/settings','event_maxivox_type')); ?></label>
                <div class="input-group date col-sm-4">
                   <span class="input-group-addon">
