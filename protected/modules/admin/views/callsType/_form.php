...
<?php $form=$this->beginWidget('CActiveForm', array(
    ...
    <?php echo $form->hiddenField($model,'id_call_type',array('id'=>'id_call_type')); ?>
    <input type="hidden" name="old_call_type" id="old_call_type" value="<?php echo $model->script;?>"/>
	...
	<div class="row">
        <div class="col-lg-6">
            <label class="control-label" for="priority"><?php echo $form->labelEx($model,Yii::t('admin/callstype','Priority')); ?></label>
    		<div class="input-group date col-sm-4">
                <span class="input-group-addon">
	...
	<div class="row">
        <div class="col-lg-2">
            <label class="control-label" for="color_hex"><?php echo $form->labelEx($model,Yii::t('admin/callstype','Color')); ?></label>
            <div id="colorPicker">
