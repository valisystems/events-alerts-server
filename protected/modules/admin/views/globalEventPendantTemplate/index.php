...
$this->breadcrumbs=array(
	Yii::t('admin/globaleventpendant', 'Global Event Pendant Templates') => array('index'),
	Yii::t('admin/globaleventpendant', 'Manage'),
);
?>
<h1><?php echo Yii::t('admin/globaleventpendant', 'Manage Global Event Pendant Templates');?></h1>
...
<?php $this->widget('zii.widgets.grid.CGridView', array(
    ...
    'summaryText'=> Yii::t('admin/globalevent', 'Displaying {start}-{end} of {count} results.'),
	'columns'=>array(
        'desc_global_event',
		array(
            'name'=>'id_pendant_type',
            'value'=>'$data->idPendantType->description',
            'filter'=>CHtml::listData(PendantType::model()->findAll(), 'id_pendant_type','description')
        ),
        array(
