...
if (isset($status)){
    ...
    if ($status == 'success_add') {
        ...
        $message = Yii::t('admin/devices', 'Added Successful');
        ...
        $message = Yii::t('admin/devices', 'Added fail');
...
<div class="form-group">
    ...
    <div class="row col-sm-9">
        <label class="control-label" for="id_patient"><?php echo $model->device_description; ?></label>
    </div>
    <div class="row col-sm-9">
