...
<?php $form=$this->beginWidget('CActiveForm', array(
    ...
    <?php echo $form->hiddenField($model,'id_pendant_type',array('id'=>'id_pendant_type')); ?>
    <input type="hidden" name="old_pendant_type" id="old_pendant_type" value="<?php echo $model->script;?>"/>
	...
	<div class="row">
        <div class="col-lg-6">
            <label class="control-label" for="description"><?php echo $form->labelEx($model,Yii::t('admin/pendanttype','Description')); ?></label>
	...
	<div class="row">
        <div class="col-lg-6">
            <label class="control-label" for="priority"><?php echo $form->labelEx($model,Yii::t('admin/pendanttype','Priority')); ?></label>
    		<div class="input-group date col-sm-4">
                <span class="input-group-addon">
	...
	<div class="row">
        <div class="col-lg-2">
            <label class="control-label" for="color_hex"><?php echo $form->labelEx($model,Yii::t('admin/pendanttype','Color')); ?></label>
            <div id="colorPicker">
	...
	<div class="row buttons">
        ...
        <?php
            ...
            echo "&nbsp;&nbsp;&nbsp;";
            echo CHtml::submitButton($model->isNewRecord ? 'Create' : 'Save', array('class'=>'btn btn-primary', 'id'=>'savePendantType')); ?>
        </div>
	</div>
<?php $this->endWidget(); ?>
