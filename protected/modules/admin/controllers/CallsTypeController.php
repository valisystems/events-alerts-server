...
class CallsTypeController extends Controller
{
	/**
    ...
    public function init(){
        ...
        $cs->registerScriptFile(Yii::app()->request->baseUrl.'/assets/js/pages/calltype.js', CClientScript::POS_END);
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['CallsType']))
		{
			$model->attributes=$_POST['CallsType'];
			if($model->save()) {
	...
	{
		$model=new CallsType('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['CallsType']))
			$model->attributes=$_GET['CallsType'];
	...
	{
		$model=CallsType::model()->findByPk($id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='calls-type-form')
		{
