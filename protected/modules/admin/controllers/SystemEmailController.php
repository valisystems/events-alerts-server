...
class SystemEmailController extends Controller
{
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['SystemEmail']))
		{
			$model->attributes=$_POST['SystemEmail'];
			if($model->save()){
	...
	{
		$model=new SystemEmail('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['SystemEmail']))
			$model->attributes=$_GET['SystemEmail'];
	...
	{
		$model=SystemEmail::model()->findByPk($id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='system-email-form')
		{
