...
class EventsManage extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('pick_event_type', 'required'),
			array('id_device, id_call_type, id_notification_settings', 'length', 'max'=>10),
			array('pick_event_type', 'length', 'max'=>1),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id_event, id_device, id_call_type, id_notification_settings, pick_event_type', 'safe', 'on'=>'search'),
		);
	}
	...
	public function attributeLabels()
	{
		return array(
			...
			'id_notification_settings' => 'Id Notification Settings',
