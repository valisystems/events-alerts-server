...
class Devices extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('device_description, coordonate_on_map', 'length', 'max'=>250),
			...
			array('device_type', 'length', 'max'=>6),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id_device, id_building, id_map, id_room, device_description, serial_number, language, activity_timer, activity_timer_status, nurce_aknowege, nurce_aknowege_status, device_type, call_duration, auto_test, auto_test_status, comon_area, id_access_number, type_access_number, coordonate_on_map', 'safe', 'on'=>'search'),
		);
	}
	...
	public function attributeLabels()
	{
		return array(
			...
			'coordonate_on_map' => 'Coordonate On Map',
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('coordonate_on_map',$this->coordonate_on_map,true);
