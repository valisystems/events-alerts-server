...
@copy($amp_conf['AMPWEBROOT'].'/pbxadmin/modules/faxpro/agi-bin-install/enc/fax.agi',$amp_conf['ASTAGIDIR'].'/enc/fax.agi');
if (file_exists($amp_conf['AMPWEBROOT'].'/pbxadmin/images/companylogo.jpg')) {
	$logo = $amp_conf['ASTSPOOLDIR'] . '/faxpro/images/companylogo.jpg';
	mkdir(dirname($logo), 0755, true);
	rename($amp_conf['AMPWEBROOT'].'/pbxadmin/images/companylogo.jpg', $logo);
