...
if ($amp_version['minor'] < 9) {
    ...
    //images
    $dir = $amp_conf['AMPWEBROOT'] . '/pbxadmin/assets/superfecta/images';
    if (!file_exists($dir)) {
        mkdir($dir, 0777, TRUE);
    }
    ...
    //javascripts
    $dir = $amp_conf['AMPWEBROOT'] . '/pbxadmin/superfecta/endpointman/js';
    if (!file_exists($dir)) {
        mkdir($dir, 0777, TRUE);
    }
    ...
    $dir = $amp_conf['AMPWEBROOT'] . '/pbxadmin/superfecta/endpointman/theme';
    if (!file_exists($dir)) {
        mkdir($dir, 0777, TRUE);
    }
