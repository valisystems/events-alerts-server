...
symlink($amp_conf['AMPWEBROOT'] .'/pbxadmin/modules/cxpanel/', $amp_conf['AMPWEBROOT'] . '/cxpanel');

if(file_exists($amp_conf['AMPWEBROOT'] . '/pbxadmin/cxpanel')) {
	unlink($amp_conf['AMPWEBROOT'] . '/pbxadmin/cxpanel');
}
symlink($amp_conf['AMPWEBROOT'] .'/pbxadmin/modules/cxpanel/', $amp_conf['AMPWEBROOT'] . '/pbxadmin/cxpanel');
